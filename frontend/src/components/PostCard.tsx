 ...
 export default function PostCard({ post }: PostCardProps) {
   ...
   return (
     <div className={`bg-white rounded-lg border ${post.isPinned ? 'border-amber-300 ring-1 ring-amber-200' : 'border-gray-200'} p-5 hover:shadow-sm transition-shadow`}>
       {post.isPinned && (
       ...
       <Link to={`/post/${post.id}`} className="block">
         <h3 className="text-lg font-semibold text-gray-900 hover:text-indigo-600 transition-colors mb-1.5">
           {post.title}
         </h3>
       </Link>
