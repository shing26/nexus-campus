...
INSERT INTO vibe_post (id, title, content, user_id, category_id, status, like_count, comment_count, view_count, is_pinned, create_time) VALUES
(1, 'Building a RAG pipeline with LangChain and Claude 3',
 ...
 2, 4, 1, 85, 24, 320, 0, DATEADD('HOUR', -2, CURRENT_TIMESTAMP)),
(2, 'Fine-tuning Llama 3 on domain-specific code: lessons learned',
 ...
 3, 5, 1, 150, 45, 890, 0, DATEADD('DAY', -1, CURRENT_TIMESTAMP)),
(3, 'Claude Computer Use: building autonomous browser agents',
 ...
 1, 4, 1, 620, 180, 4500, 0, DATEADD('DAY', -7, CURRENT_TIMESTAMP)),
(4, 'Prompt patterns for reliable structured output from LLMs',
 ...
 4, 1, 1, 230, 67, 1200, 0, DATEADD('HOUR', -3, CURRENT_TIMESTAMP)),
(5, '[Pending Audit] AI-generated music with Stable Audio and Suno: a comparison',
 ...
 3, 7, 2, 0, 0, 10, 0, CURRENT_TIMESTAMP);
